    ...
    <div className="space-y-6">
      ...
      <div className="bg-green-800 rounded-xl p-5 border border-green-600">
        <div className="flex justify-between items-center">
          <div>
            <h2 className="text-xl font-bold text-white">{me.name}</h2>
            <p className="text-green-300 text-sm">in {game.hostName}&apos;s game · code: <span className="font-mono text-yellow-400">{gameId}</span></p>
          </div>
          <div>
